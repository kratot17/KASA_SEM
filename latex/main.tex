...
Výpočet objektivních metrik byl realizován pomocí komplexního filtru (\texttt{-lavfi}) integrovaného přímo ve FFmpeg, který v~jednom průchodu generuje logy pro PSNR, SSIM a~VMAF, což eliminuje chyby vzniklé při externím zpracování souborů a~šetří strojový čas.
