...
\begin{itemize}
    ...
    \item \textbf{Objem dat a~kompresní poměr:} Všechna referenční videa mají délku 10 sekund (500 snímků). Vzhledem k~absenci komprese je jejich velikost na disku přesně identická, a~to \textbf{1~555~203~036 bajtů} (cca 1483,16 MiB).
...
\hline
\textbf{Kodér} & \textbf{\hyperref[sec:derived_metrics]{FPS}} & \textbf{Čas [s]} & \textbf{Původní [MiB]} & \textbf{Komprim. [MiB]} & \textbf{Úspora} \\
\hline
